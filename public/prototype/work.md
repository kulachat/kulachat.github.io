...
- Logic หลักอยู่ใน `script.js`

ไฟล์หลัก:

- `index.html`: layout, Tailwind config, page structure, drawer markup
- `script.js`: data mock, render list/table/card, drawer state, page navigation, loading state
- `Step 1.png` ถึง `Step 4.png`: reference image สำหรับ flow เดิม
...
ข้อมูลเป็น mock data ใน `script.js`
